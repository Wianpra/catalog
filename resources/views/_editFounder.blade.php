        ...
        <div class="card-body">
                ...
                <div class="row" id="updateProduct">
                    ...
                    <div class="form-group text-center col-12">
                        <button type="button" onclick="updateFounder({{$data->id}})" class="btn btn-primary my-2">Update Founder</button>
                    </div>
                </div>
        </div>
        @endsection
